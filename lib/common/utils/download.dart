...
Future<DownloadTask> singleStartDownloadFromHtml(WidgetRef? ref, Object html,
  ...
  var metas = document.querySelector('head')!.getElementsByTagName('meta');
  for (var meta in metas) {
    if (meta.attributes['name'] == 'title') {
      titleText = meta.attributes['content']!;
    } else if (meta.attributes['name'] == 'author') {
      titleText = meta.attributes['content']!;
    }
  }
