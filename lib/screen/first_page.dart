...
Future<DownloadTask> _singleStartDownload(String myUrl, int index) async {
...

  {
    ...
    count++;
    if (Platform.isAndroid || Platform.isIOS) {
      await _progressNotification(titleText, count, 1);
    }
  }
...
Future<void> onPressSingleStartDownload(String url, int index) async {
  var result = await _singleStartDownload(url, index);
